...
int main() {
	...
	RayTracer tracer(output_width, output_height, near_clip, far_clip);
	...
	tracer.addHitable(new Sphere(vector3(0.0, 0.0, -1.0), 0.5));
	//tracer.addHitable(new Sphere(vector3(0.75, 0.0, -1.0), 0.5));

	// Huge sphere used as pseudo ground
	tracer.addHitable(new Sphere(vector3(0.0, -100, -30.0), 100));
